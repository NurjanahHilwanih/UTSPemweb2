        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="count_array.php" class="nav-link active">
                  <p>
                    Count Array
                  </p>
                </a>
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <?php
            ...
            $_fruits = ["Apel", "Pisang", "Jambu biji", "Pepaya", "Markisa"];
            $_jumlah = count($_fruits);  //untuk menjumlah semua buah yang ada pada variabel fruits

            for ($i = 0 ; $i < $_jumlah ; $i++){
                echo "Buah index ke - " . $i . " adalah " . $_fruits[$i];
                echo "<br/>";
            }
            echo "<br/>";
            echo "Jumlah semua buah = " . $_jumlah;
          ?>
