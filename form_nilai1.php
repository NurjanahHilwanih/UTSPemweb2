...
<div class="wrapper">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="form_nilai1.php" class="nav-link active">
                  <p>
                    Form Nilai 1
                  </p>
                </a>
  ...
  <div class="content-wrapper">
    ...
    <?php
        ...
        if(isset($_GET["matkul"])){
            ...
            $_matkul = "Mata Kuliah tidak ada";
        }


        if(isset($_GET["nilai_uts"])){
            $_nilai_uts = $_GET["nilai_uts"];
        }
        else{
            $_nilai_uts = "Nilai UTS belum di masukkan";
        }


        if(isset($_GET["nilai_uas"])){
            $_nilai_uas = $_GET["nilai_uas"];
        }
        else{
            $_nilai_uas = "Nilai UAS belum di masukkan";
        }
        ...
        if(isset($_GET["nilai_tugas"])){
            ...
            $_nilai_tugas = "Nilai tugas belum di masukkan";
        }
  ...
  <footer class="main-footer">
    <div class="float-right d-none d-sm-block">
        <nav class="navbar navbar-light bg-light">
        <p>Develop by @salsabilafarah ©2022</p>
    </nav>
    </div>
  </footer>
