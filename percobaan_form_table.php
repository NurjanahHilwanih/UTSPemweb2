  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <input id="tanggal" name="tanggal" placeholder="yyyy-mm-dd" type="text" class="form-control" required="required" aria-describedby="tanggalHelpBlock"> 
      <span id="tanggalHelpBlock" class="form-text text-muted">Masukkan tanggal periksa dengan urutan tahun, bulan, tanggal.</span>
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <input id="tinggi" name="tinggi" placeholder="Masukkan Tinggi Badan (m)" type="text" class="form-control" required="required">
    </div>
  </div> 
  <div class="form-group row">
...
<?php
    ...
    $dp1 = ['id'=>1,'Tanggal_Periksa'=>'2022-01-10', 'Kode_Pasien' => 'P001','Nama_Pasien'=>'Ahmad','Gender'=> 'L','Berat'=>69.8, 'Tinggi'=>1.69, 'Nilai_BMI'=>24.7, 'Status_BMI'=>'Kelebihan Berat Badan'];
    $dp2 = ['id'=>2,'Tanggal_Periksa'=>'2022-01-10', 'Kode_Pasien' => 'P002','Nama_Pasien'=>'Rina','Gender'=> 'P','Berat'=>55.3, 'Tinggi'=>1.65, 'Nilai_BMI'=>20.3, 'Status_BMI'=>'Normal (Ideal)'];
    $dp3 = ['id'=>3,'Tanggal_Periksa'=>'2022-01-11', 'Kode_Pasien' => 'P003','Nama_Pasien'=>'Lutfi','Gender'=> 'L','Berat'=>45.2, 'Tinggi'=>1.71, 'Nilai_BMI'=>15.4, 'Status_BMI'=>'Kekurangan Berat Badan'];
